...
abstract final class PatrolNotificationActions {
  ...
  static const String sessionExpiredPayload = 'patrol_session_expired';
  ...
  static Future<void> handleResponse(NotificationResponse response) async {
    ...
    if (payload == sessionExpiredPayload) {
      await _onSessionExpiredNotification();
      return;
    }
  ...
  static Future<void> _onSessionExpiredNotification() async {
